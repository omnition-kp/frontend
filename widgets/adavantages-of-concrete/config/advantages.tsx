...
export const ADVANTAGES: AdvantageBlockProps[] = [
    ...
    },
    {
        ...
        description:
            "Имеем подтвержденный опыт по созданию специализированных высокопробных бетонов",
        children: (
            <NumberText
                title="B40-B100"
                className={cn("text-gray", adaptation_class_for_number)}
    ...
    },
    {
        ...
        description:
            "Эксплуатация без ремонта в зонах с высокой проходимостью — метро, вокзалы и торговые центры",
        children: (
            <NumberText
                title="до 50 лет"
                className={cn("text-gray", adaptation_class_for_number)}
